  ...
  return (
    <section className=" flex flex-col w-full h-screen">
      <div className="w-full">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVtW3RCjvfTna1l5657R5TVMjbw-JObpOZ2Q&s"
          className="h-16 w-full object-cover"
        />
      </div>
      <div className="h-full w-full p-1">
        <ul className="flex flex-col items-start justify-center text-sm mt-2 px-1">
          <li className="w-full flex items-center gap-4 mt-2 p-1 rounded-md cursor-pointer hover:bg-customBlue hover:text-white">
            <svg
          ...
          <li className="w-full flex items-center justify-start gap-4 mt-2 p-1 rounded-md cursor-pointer hover:bg-customBlue hover:text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
